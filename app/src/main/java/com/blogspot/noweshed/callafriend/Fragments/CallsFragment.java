...
public class CallsFragment extends Fragment {
    ...
    private LinearLayout noCallsLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCallList = mMainView.findViewById(R.id.fragmentPageId);
        noCallsLayout = mMainView.findViewById(R.id.noCallsLay);
        ...
        noCallsLayout.setVisibility(View.VISIBLE);

        mCallList.setHasFixedSize(true);
        mCallList.setLayoutManager(new LinearLayoutManager(getContext()));
